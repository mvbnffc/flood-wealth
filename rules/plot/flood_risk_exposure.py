"""
This script creates a flood risk GeoTiff for plotting / mapping.
"""
...
logging.info(f"Creating flood risk exposure GeoTiff in {country} using {model} model and {vuln}.")
