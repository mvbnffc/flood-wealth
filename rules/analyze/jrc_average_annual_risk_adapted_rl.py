...
def main(RP10_path, RP20_path, RP50_path, RP75_path, RP100_path, RP200_path, RP500_path, flopros_path, aar_output_path, urban_class, vuln_dataset):
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            urban_class: str = sys.argv[10]
            vuln_dataset: str = sys.argv[11]
        except IndexError:
            print("""\
Example usage: python rules/analyze/jrc_average_annual_risk_adapted_rl.py \\
    ...
    data/inputs/analysis/countries/CRI/CRI_adaptation_rl_m-jrc_duc13.tif \\
...
""")
    ...
    main(RP10_path, RP20_path, RP50_path, RP75_path, RP100_path, RP200_path, RP500_path, flopros_path, aar_output_path, urban_class, vuln_dataset)
