...
def main(RP10_path, RP20_path, RP50_path, RP75_path, RP100_path, RP200_path, RP500_path, flopros_path, aar_output_path, vuln_dataset):
...
""")
    ...
    main(RP10_path, RP20_path, RP50_path, RP75_path, RP100_path, RP200_path, RP500_path, flopros_path, aar_output_path, vuln_dataset)