...
def main(RP2_path, RP5_path, RP_10_path, RP25_path, RP50_path, RP100_path, RP250_path, RP500_path, RP1000_path, flopros_path, aar_output_path, vuln_dataset):
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            print("""\
Example usage: python rules/analyze/wri_average_annual_risk_protected.py \\
...
""")
    ...
    main(RP2_path, RP5_path, RP10_path, RP25_path, RP50_path, RP100_path, RP250_path, RP500_path, RP1000_path, flopros_path, aar_output_path, vuln_dataset)
