...
def main(RP5_path, RP_10_path, RP25_path, RP50_path, RP100_path, RP200_path, RP500_path, RP1000_path, flopros_path, aar_output_path, vuln_dataset):
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            vuln_dataset: str = sys.argv[11]
        except IndexError:
            print("""\
Example usage: python rules/analyze/giri_average_annual_risk_protected.py \\
...
""")
    ...
    main(RP5_path, RP10_path, RP25_path, RP50_path, RP100_path, RP200_path, RP500_path, RP1000_path, flopros_path, aar_output_path, vuln_dataset)
