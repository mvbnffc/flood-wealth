...
def main(RP5_path, RP10_path, RP25_path, RP50_path, RP100_path, RP200_path, RP500_path, RP1000_path, flopros_path, aar_output_path, rp_protection, urban_class, vuln_dataset):
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            rp_protection: str = sys.argv[11]
            urban_class: str = sys.argv[12]
            vuln_dataset: str = sys.argv[13]
        except IndexError:
            print("""\
Example usage: python rules/analyze/giri_average_annual_risk_adapted_fp.py \\
...
""")
    ...
    main(RP5_path, RP10_path, RP25_path, RP50_path, RP100_path, RP200_path, RP500_path, RP1000_path, flopros_path, aar_output_path, rp_protection, urban_class, vuln_dataset)
