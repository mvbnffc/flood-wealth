...
for each flooded grid cell. This is for the relocation adaptation scenario.
"""
...
def main(RP5_path, RP10_path, RP25_path, RP50_path, RP100_path, RP200_path, RP500_path, RP1000_path, flopros_path, aar_output_path, urban_class, vuln_dataset):
    ...
    raster_paths = [RP1000_path, RP500_path, RP200_path, RP100_path, RP50_path, RP25_path, RP10_path, RP5_path]
    ...
    RPs = np.array([1000, 500, 200, 100, 50, 25, 10, 5, 2], dtype="float32") # define return periods
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            RP5_path: str = sys.argv[1]
            RP10_path: str = sys.argv[2]
            RP25_path: str = sys.argv[3]
            RP50_path: str = sys.argv[4]
            RP100_path: str = sys.argv[5]
            RP200_path: str = sys.argv[6]
            RP500_path: str = sys.argv[7]
            RP1000_path: str = sys.argv[8]
            flopros_path: str = sys.argv[9]
            aar_output_path: str = sys.argv[10]
            urban_class: str = sys.argv[11]
            vuln_dataset: str = sys.argv[12]
        except IndexError:
            print("""\
Example usage: python rules/analyze/giri_average_annual_risk_adapted_rl.py \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_RP5_V-JRC.tif \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_RP10_V-JRC.tif \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_RP25_V-JRC.tif \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_RP50_V-JRC.tif \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_RP100_V-JRC.tif \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_RP200_V-JRC.tif \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_RP500_V-JRC.tif \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_RP1000_V-JRC.tif \\
    data/inputs/analysis/countries/CRI/CRI_adaptation_rl_m-giri_duc13.tif \\
    data/results/flood_risk/countries/CRI/CRI_giri-flood-risk_protected_AAR_V-JRC.tif \\
    13 \\
    JRC
""")
            raise ValueError("Must be run via snakemake or with all parameters supplied.")
        
    main(RP5_path, RP10_path, RP25_path, RP50_path, RP100_path, RP200_path, RP500_path, RP1000_path, flopros_path, aar_output_path, urban_class, vuln_dataset)