...
rule relative_flood_risk:
    ...
    """
    input:
        flood_file="data/inputs/analysis/{ISO3}/{ISO3}_{MODEL}-flood_RP{RP}.tif"
    output:
        risk_file="data/results/flood_risk/{ISO3}/{ISO3}_{MODEL}-flood-risk_RP{RP}_V-{VULN_CURVE}.tif"
...
""" 
Test with
snakemake -c1 data/results/flood_risk/KEN/KEN_giri-flood-risk_RP10_V-JRC.tif
"""
